                ...
                if (b.get_raw_json) b.callback(JSON.stringify({
                    ...
                    if (b.display_gallery)
                        if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                            ...
                            c += "<div class='social_connect'>";
                            for (d = 0; d < max; d++) c += "<div class='single-social_connect'><div class='social_connect_img'>", c += "\t<img src='" +
                                a[d].node.thumbnail_src + "' alt='" + b.username + " instagram image " + d + "'" + k + " /><div class='social_connect_overlay'><a href='https://www.instagram.com/p/" + a[d].node.shortcode + "' target='_blank'><span class='ti-instagram'></span></a>", c += "</div></div></div></a>";
                            c += "</div>"
