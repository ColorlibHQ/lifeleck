(function( $ , api){
    ...
    api.section( 'lifeleck_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'lifeleck_about_section' , function( section ){
    ...
    api.section( 'lifeleck_blog_section' , function( section ){
    ...
    api.section( 'lifeleck_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-lifeleck_contact_custom_formshortcode'),
                selector = $('#_customize-input-lifeleck_contact_formshortcode');
    ...
    // General section
    api.section( 'lifeleck_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#lifeleck_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-lifeleck_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-lifeleck_preloader_color' );
            ...
            var $backtotop          = $( '#lifeleck_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-lifeleck_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-lifeleck_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'lifeleck_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#lifeleck_footer_widget_toggle');
