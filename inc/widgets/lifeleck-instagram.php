...
----------------------------------------*/
class lifeleck_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('lifeleck_instagram_photo',esc_html__('[ Lifeleck ] Intagram Photo','lifeleck'),array(
			'description' => esc_html__('Lifeleck Instagram Photo Widget','lifeleck'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'lifeleck');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'lifeleck'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'lifeleck'); ?></label>
...
if(!function_exists('lifeleck_instagram_widgets')):
	function lifeleck_instagram_widgets(){
		register_widget('lifeleck_instagram_photo');
	}
	add_action('widgets_init','lifeleck_instagram_widgets');
endif;
