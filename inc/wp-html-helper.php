...
// image default alt
if( !function_exists( 'lifeleck_img_default_alt' ) ){
	function lifeleck_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'lifeleck_img_tag' ) ){
	function lifeleck_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = lifeleck_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'lifeleck_anchor_tag' ) ){
	function lifeleck_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'lifeleck_heading_tag' ) ){
	function lifeleck_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'lifeleck_paragraph_tag' ) ){
	function lifeleck_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'lifeleck_other_tag' ) ){
	function lifeleck_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'lifeleck_button_element ' ) ){
	function lifeleck_button_element( array $args ){
